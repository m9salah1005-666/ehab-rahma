function openCurtains() {
    ...
    setTimeout(() => {
        ...
        // فتح السكرول أول ما الستارة تفتح والدعوة تظهر
...
// تم التعديل: 5 أكتوبر 2026 الساعة 8:00 مساءً
const targetDate = new Date("September 23, 2026 19:00:00").getTime();
...
function toggleMusic() {
    ...
    if (music.paused) {
        ...
        btn.innerText = '🎵'; // شكل الأيقونة وهي شغالة
    } else {
        music.pause();
        btn.classList.remove('playing');
        btn.innerText = '🔇'; // شكل الأيقونة وهي مقفولة
    }
}